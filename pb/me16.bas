...
modex%=1
modey%=2
omega=1.5*sqr((modex%^2+modey%^2)/2)
ell=15
ellx=ell*nxb%
elly=ell*nyb%
c=.2
...
for nx=0 to nxb%
for ny=0 to nyb%
call threedline(-ellx+2*ellx*nx/(nxb%+1),-elly+2*elly*ny/(nyb%+1),dz*sin(omega*t)*(fna(nx,ny)+fna(ny,nx)),-ellx+2*ellx*(nx+1)/(nxb%+1),-elly+2*elly*ny/(nyb%+1),dz*sin(omega*t)*(fna((nx+1),(ny))+fna(ny,(nx+1))),cll)
call threedline(-ellx+2*ellx*nx/(nxb%+1),-elly+2*elly*ny/(nyb%+1),dz*sin(omega*t)*(fna(nx,ny)+fna(ny,nx)),-ellx+2*ellx*(nx)/(nxb%+1),-elly+2*elly*(ny+1)/(nyb%+1),dz*sin(omega*t)*(fna((nx),(ny+1))+fna((ny+1),nx)),cll)
next
next
...
call threedline(0,-1.2*elly,-29,-30,-1.2*elly,-29,12)
call threedline(-30,-1.2*elly,-29,-25,-1.2*elly,-32,12)
call threedline(-30,-1.2*elly,-29,-25,-1.2*elly,-26,12)
'print
