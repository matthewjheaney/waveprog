...
xi2=th-4*thp
line (x0-r*cos(xi1),y0+r*sin(xi1))-(x0-r*cos(xi2),y0+r*sin(xi2)),cl
xi3=xi2+th
line (x0-r*cos(xi2)-350*cos(xi3),y0+r*sin(xi2)+350*sin(xi3))-(x0-r*cos(xi2),y0+r*sin(xi2)),cl
end sub
