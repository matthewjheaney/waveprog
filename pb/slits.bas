...
if jr=2 then fnd=fns(x/2^(1/2))*fns(y/2^(1/2)/2)
if jr=3 then fnd=fns(x/2^(1/2)/2)*fns(y/2^(1/2))
if jr=4 then fnd=fns(2*x/2^(1/2))*fns(y/2^(1/2))
if jr=5 then fnd=fns(x/2^(1/2))*fns(2*y/2^(1/2))
if jr=6 then fnd=fns(2*x/2^(1/2))*fns(2*y/2^(1/2))
end def
